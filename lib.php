...
/**
 * Moodle RESTful client
 *
 * It has been implemented for unit testing purpose (all protocols have similar client)
 *
 * @package    webservice_restful
 * @copyright  Matt Porritt <mattp@catalyst-au.net>c
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class webservice_restful_client {

    /** @var moodle_url the RESTful server url */
    private $serverurl;
    ...
    /**
     * Set the token used to do the RESTful call
     *
     * @param string $token the token used to do the web service call
     */
